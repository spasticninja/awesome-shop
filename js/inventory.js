angular.module('awesome-shop').constant('inventory', [{
  ...
  imgs: [
    ...
    'images/items/unisex-tee-n7-3.jpg'
  ],
  ...
  imgs: [
    ...
    'images/items/unisex-tee-marvel-hydra-2.gif'
  ],
  ...
  imgs: [
    ...
    'images/items/unisex-tee-ministry-sillywalks-2.jpg'
  ],
  ...
  shortDes: 'Your friends will think you so fashion forward when you sport this droid-era tank, reminiscent of fashion from a long time ago in a galaxy far, far away.',
  longDes: 'Everyone in fashion is looking for the next big thing. You want cool. You want modern! What could be cooler (seriously, he is made of metal) and more modern (although, actually it happened long ago in a galaxy far, far away) than this R2D2 Ladies tunic tank! Basically, it makes you look like you are Artoo. People will be so fooled. SO FOOLED. <br/> 95% cotton and 6% spandex white colored tunic tank with R2D2 print in the front.',
  price: 24.99
},{
  id: 0002004,
  item: 'Tank',
